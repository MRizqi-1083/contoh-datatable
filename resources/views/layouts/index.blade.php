...
<head>
    ...
    <meta name="author" content="{{ env('APP_BY') }}" />
                ...
                <div class="menu-item dropdown dropdown-mobile-full">
                    <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                        <div class="menu-img online">
                            <img src="{{ asset('/img/user/profile.jpg') }}" alt="Profile" height="60" />
                        </div>
                        <div class="menu-text d-sm-block d-none"><span>Muhammad Rizqi</span>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ url('logout') }}">LOGOUT <i
